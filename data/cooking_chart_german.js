/* data/cooking_chart_german.js */
const headers_de = {
  air_fry: "Air Fry Kochtabelle",
  max_crisp: "Max Crisp Kochtabelle",
  roast: "Braten (Roast) Kochtabelle",
  bake: "Backen (Bake) Kochtabelle",
  dehydration: "Dehydrierungstabelle (Dehydrate)"
};

const tableHeaders_de = {
  table_air_fry: ["ZUTAT", "MENGE", "VORBEREITUNG", "IN ÖL SCHWENKEN", "TEMPERATUR", "GARZEIT"],
  table_max_crisp: ["ZUTAT", "MENGE", "VORBEREITUNG", "IN ÖL SCHWENKEN", "GARZEIT"],
  table_roast: ["ZUTAT", "MENGE", "VORBEREITUNG", "IN ÖL SCHWENKEN", "TEMPERATUR", "GARZEIT"],
  table_bake: ["ZUTAT", "MENGE", "VORBEREITUNG", "IN ÖL SCHWENKEN", "TEMPERATUR", "GARZEIT"],
  table_dehydration: ["ZUTATEN", "VORBEREITUNG", "TEMPERATUR", "DEHYDRIERUNGSZEIT"]
};
  ...
  table_air_fry: [
    {
      header: "GEMÜSE",
      items: [
        { ingredient: "Blumenkohl", amount: "1.0 kg", preparation: "In 2.5 cm große Röschen geschnitten", oil: "2 EL", temperature: "200 °C", cook_time: "22 min" },
        { ingredient: "Brokkoli", amount: "500 g", preparation: "In 2.5 cm große Röschen geschnitten", oil: "1 EL", temperature: "200 °C", cook_time: "15 min" },
        {
        ...
        { ingredient: "Grüne Bohnen", amount: "500 g", preparation: "Enden abgeschnitten", oil: "1 EL", temperature: "200 °C", cook_time: "15 min" },
        ...
        {
          ingredient: "Hokkaidokürbis",
          group: [
            { amount: "1.0 kg", preparation: "In schmale Streifen geschnitten", oil: "1 EL", temperature: "180 °C", cook_time: "13 min" },
          ]
        },
        {
          ingredient: "Kartoffeln",
          group: [
            { amount: "1 kg", preparation: "In 2.0 cm breite Spalten geschnitten", oil: "1 EL", temperature: "200 °C", cook_time: "22-26 min" },
        ...
        { ingredient: "Möhren", amount: "1.0 kg", preparation: "Geschält und in 0.5-1.0 cm große Stücke geschnitten", oil: "1 EL", temperature: "200 °C", cook_time: "20 min" },
        { ingredient: "Paprika", amount: "500 g", preparation: "In 2.0 cm große Stücke geschnitten", oil: "Kein Öl", temperature: "200 °C", cook_time: "15 min" },
        { ingredient: "Pilze", amount: "300 g", preparation: "Gebürstet, geviertelt", oil: "1 EL", temperature: "200 °C", cook_time: "13 min" },
        { ingredient: "Rosenkohl", amount: "500 g", preparation: "Halbiert, Strunk entfernt", oil: "1 EL", temperature: "200 °C", cook_time: "14 min" },
        { ingredient: "Rote Bete", amount: "6 kleine oder 4 große (ca. 1 kg)", preparation: "Ganz", oil: "Kein Öl", temperature: "200 °C", cook_time: "45-60 min" },
        {
          ...
          group: [
            { amount: "1.0 kg", preparation: "In 0.5-1.0 cm große Stücke geschnitten", oil: "1 EL", temperature: "200 °C", cook_time: "15-20 min" },
        ...
        { ingredient: "Spargel", amount: "250 g", preparation: "Ganz, Enden der Stangen abgeschnitten", oil: "2 TL", temperature: "200 °C", cook_time: "6-8 min" },
        {
          ingredient: "Zucchini",
          group: [
            { amount: "1.0 kg", preparation: "Der Länge nach geviertelt, dann in 1.0 cm große Stücke geschnitten", oil: "1 EL", temperature: "200 °C", cook_time: "15-20 min" },
    ...
    },
    {
      ...
      items: [
        ...
        { ingredient: "Hähnchenflügel", amount: "1 kg", preparation: "Ober- und Unterschenkelknochen", oil: "Mit Öl bestreichen", temperature: "200 °C", cook_time: "27-30 min" },
        {
    ...
    },
    {
      ...
      items: [
        ...
        { ingredient: "Garnelen", amount: "16 große (165 g)", preparation: "Ganz, geschält, mit Schwanz", oil: "1 EL", temperature: "200 °C", cook_time: "9-11 min" },
        { ingredient: "Hummerschwänze", amount: "4", preparation: "Ganz", oil: "Kein Öl", temperature: "190 °C", cook_time: "5-8 min" },
        ...
        { ingredient: "Lachsfilets", amount: "4 Filets (520 g)", preparation: "Keine", oil: "Mit Öl bestreichen", temperature: "200 °C", cook_time: "10-13 min" }
      ]
    },
    {
      header: "RIND",
      items: [
        { ingredient: "Burger", amount: "4 (jeweils 113 g)", preparation: "2,5 cm dick", oil: "Kein Öl", temperature: "190 °C", cook_time: "8-10 min" },
        { ingredient: "Steaks", amount: "2 Steaks (jeweils 230 g)", preparation: "Ganz", oil: "Mit Öl bestrichen", temperature: "200 °C", cook_time: "6-10 min" }
      ]
    },
    {
      ...
      items: [
        ...
        { ingredient: "Schweinefilets", amount: "2 (je 350-500g)", preparation: "Keine", oil: "Mit Öl bestrichen", temperature: "190 °C", cook_time: "25-30 min" },
        {
          ...
          group: [
            { amount: "2 dick geschnittene Koteletts mit Knochen (jeweils 250 g)", preparation: "Keine", oil: "Mit Öl bestrichen", temperature: "190 °C", cook_time: "14-17 min" },
            { amount: "4 entpbeinte (jeweils 100g)", preparation: "Entbeint", oil: "Mit Öl bestrichen", temperature: "190 °C", cook_time: "14 min" }
          ]
        },
        {
          ingredient: "Wurst",
          group: [
            { amount: "4-8 Würste (205-410 g)", preparation: "Ganz", oil: "Kein Öl", temperature: "200 °C", cook_time: "8-10 min" },
          ]
        }
      ]
    },
    ...
    },
    {
      ...
      items: [
        ...
        { ingredient: "Fischstäbchen", amount: "10 (280 g)", preparation: "Keine", oil: "Kein Öl", temperature: "200 °C", cook_time: "13-14 min" },
        ...
        { ingredient: "Hähnchennuggets", amount: "700 g", preparation: "Keine", oil: "Kein Öl", temperature: "200 °C", cook_time: "20-22 min" },
        ...
        { ingredient: "Panierte Champignons", amount: "300 g", preparation: "Keine", oil: "Kein Öl", temperature: "170 °C", cook_time: "15-18 min" },
        { ingredient: "Panierte Scampi", amount: "280 g", preparation: "Keine", oil: "Kein Öl", temperature: "180 °C", cook_time: "12 min" },
        { ingredient: "Gefüllte Bällchen", amount: "12 (310 g)", preparation: "Keine", oil: "Mit Öl bestrichen", temperature: "160 °C", cook_time: "18-20 min" },
        { ingredient: "Würstchen im Teigmantel", amount: "24 (400 g)", preparation: "Mit verrührtem Ei bestreichen", oil: "Kein Öl", temperature: "200 °C", cook_time: "12-13 min" },
        ...
        { ingredient: "Zwiebelringe", amount: "375 g", preparation: "Kein Öl", oil: "Kein Öl", temperature: "180 °C", cook_time: "12 min" },
      ]
    },
    {
      header: "POMMES FRITES",
      items: [
        { ingredient: "Handgeschnittene Pommes frites, 1 cm dick", amount: "500 g", preparation: "30 min in Wasser legen, trocken tupfen", oil: "1-3 EL Pflanzenöl", temperature: "200 °C", cook_time: "14-18 min" },
        ...
        { ingredient: "Tiefgefrorene Süßkartoffelpommes", amount: "500 g", preparation: "Keine", oil: "Keine", temperature: "190 °C", cook_time: "20-22 min" }
      ]
    }
  ],
  ...
  table_max_crisp: [
    {
      header: "TIEFGEFRORENE LEBENSMITTEL",
      items: [
        { ingredient: "Hähnchennuggets", amount: "24 (350 g)", preparation: "Keine", oil: "Kein Öl", cook_time: "9 min" },
        {
        ...
        { ingredient: "Chicken Wings", amount: "700 g", preparation: "Keine", oil: "1 EL", cook_time: "25 min" },
        ...
        { ingredient: "Mozzarella-Sticks", amount: "700 g", preparation: "Keine", oil: "Kein Öl", cook_time: "6-8 min" },
